...
MIDDLEWARE = [
    ...
    "app.accounts.middleware.SecurityHeadersMiddleware",
    "app.accounts.middleware.RequestValidationMiddleware",
    "app.accounts.middleware.SuperUserEmailLoginMiddleware",
]
